...
class FaceParseTool(nn.Module):
    def __init__(self, n_classes=19, ref_path=None):
        ...
        self.net.load_state_dict(torch.load("/userhome/yjw/ddgm_exp/functions/face_parsing/79999_iter.pth"))
        self.net.eval()
...
#         self.reference_img_path = "/userhome/yjw/ddgm_exp/functions/face_parsing/00234.png" 
        self.reference_img_path = "/userhome/yjw/ddgm_exp/functions/face_parsing/43.jpg" if not ref_path else ref_path
...
if __name__ == "__main__":
    net = BiSeNet(19)
    net.cuda()
    net.load_state_dict(torch.load("/userhome/yjw/ddgm_exp/functions/face_parsing/79999_iter.pth"))
    net.eval()
    reference_img_path = "/userhome/yjw/ddgm_exp/functions/face_parsing/43.jpg"
    from PIL import Image
